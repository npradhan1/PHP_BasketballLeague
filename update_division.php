...
//		array_multisort($dname, SORT_ASC, $tno, SORT_ASC, $data);
	...
	foreach ($data as $key => $row) {
				...
				$show_list[$key]= "<tr height=\"25\"><td><div align=\"center\">$dcode[$key]</div></td>
						<td><div align=\"center\"><a href=\"update_division1.php?dcode=$dcode[$key]\">$dname[$key]</a></div></td>
...
<table align=center>
<tr><td align="left"><align="left" style="color:red; font-size: 12px;"/><?php echo "Select a division";?> </td></tr>
</table>
