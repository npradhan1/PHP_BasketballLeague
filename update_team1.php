<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		mysql_query("UPDATE team SET coach = '{$_SESSION['coach']}'
		 where (dcode ='{$_SESSION['dcode']}')&&(tno ='{$_SESSION['tno']}')");
		header('location: update_team.php');		
...
<td width="100"><div align="center">TEAM NUMBER</div></td>
<td width="100"><div align="center">TEAM(COACH)</div></td>
</tr>
...
</td></tr><tr><td align="right"><input type="button"  onClick="location.href='update_team.php'" value="Back" style="background-color:white; color:black;"></input>
