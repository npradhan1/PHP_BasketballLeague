...
&nbsp;<input type="button" onClick="location.href='add_commissioner1.php?userid=<?php echo $_SESSION['userID']?>'"  value="Add" style="background-color:white; color:black;"></input>
</td></tr>
