<?php
	...
	foreach ($data as $key => $row) {
				...
				$show_list[$key]= "<tr height=\"25\"><td><div align=\"center\">$gamedate[$key]</div></td>
						...
						<td><div align=\"center\"><a href=\"update_schedule1.php?gid=$gid[$key]&dcode=$dcode[$key]\">$awayteam[$key] &nbsp; vs &nbsp; $hometeam[$key]</a></div></td>
...
<tr height=30>
<td><align="left" style="color:red; font-size: 12px;"/><?php echo "Please Click a Schedule to Update";?> &nbsp;</td></tr></table>
<table align=center width="500">
