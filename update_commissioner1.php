	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if(count($error_arr) == 0){
			...
			mysql_query("UPDATE users SET password = '{$_SESSION['passwd']}'
			 where userid ='{$_SESSION['commissioner']}'");
			header('location: update_commissioner.php');		
		}
	}
...
<td><div align="center"><?php echo $commissioner;?></div></td>
<td><div align="center">
...
</td></tr><tr><td align="right"><input type="button"  onClick="location.href='update_commissioner.php'" value="Back" style="background-color:white; color:black;"></input>
