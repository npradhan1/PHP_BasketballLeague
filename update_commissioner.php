...
//		array_multisort($dname, SORT_ASC, $tno, SORT_ASC, $data);
	...
	foreach ($data as $key => $row) {
				...
				$show_list[$key]= "<tr height=\"25\"><td><div align=\"center\">$dname[$key]</div></td>
						<td><div align=\"center\"><a href=\"update_commissioner1.php?commissioner=$commissioner[$key]\">$commissioner[$key]</a></div></td>
...
<table align=center>
<tr><td align="left"><align="left" style="color:red; font-size: 12px;"/><?php echo "Please Click a Commissioner ID to Update";?> </td></tr>
</table>
...
<td width="100"><div align="center">Commissioner ID</div></td>
</tr>
<?php
	$num = 0;
